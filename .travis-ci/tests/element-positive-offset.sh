...
##
#
tests__element_positive_offset() {
    printf 'Started: %s\n' "${FUNCNAME[0]}"
    ...
    array_splice --target test_one --deleted deleted_list --element '--two' --offset 1
    ...
    array_splice --target test_two --deleted deleted_list --element '--one' --offset 3
